...
<div class="max-w-md mx-auto mt-10 bg-white p-8 rounded-lg shadow-lg">
    ...
    <form method="POST" action="{{ route('tourPlan.store') . "?step=3&tour_id=" . request()->get('tour_id') }}">
        @csrf
        <div class="mb-4">
        ...
        <div class="mb-4">
            ...
            <input type="text" id="cardNumber" name="price" value="{{ request()->price }}" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" placeholder="{{ $price . "AZN" }}">
        </div>
